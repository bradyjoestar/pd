...
func (op Op) Txn() ([]clientv3.Cmp, []Op, []Op) {
...
func OpTxn(cmps []clientv3.Cmp, thenOps []Op, elseOps []Op) Op {
...
func WithLease(leaseID clientv3.LeaseID) OpOption {
...
func WithSort(target clientv3.SortTarget, order clientv3.SortOrder) OpOption {
	return func(op *Op) {
		if target == clientv3.SortByKey && order == clientv3.SortAscend {
		...
		op.sort = &clientv3.SortOption{target, order}
	}
}
...
func WithFirstCreate() []OpOption { return withTop(clientv3.SortByCreateRevision, clientv3.SortAscend) }

// WithLastCreate gets the key with the latest creation revision in the request range.
func WithLastCreate() []OpOption { return withTop(clientv3.SortByCreateRevision, clientv3.SortDescend) }

// WithFirstKey gets the lexically first key in the request range.
func WithFirstKey() []OpOption { return withTop(clientv3.SortByKey, clientv3.SortAscend) }

// WithLastKey gets the lexically last key in the request range.
func WithLastKey() []OpOption { return withTop(clientv3.SortByKey, clientv3.SortDescend) }

// WithFirstRev gets the key with the oldest modification revision in the request range.
func WithFirstRev() []OpOption { return withTop(clientv3.SortByModRevision, clientv3.SortAscend) }

// WithLastRev gets the key with the latest modification revision in the request range.
func WithLastRev() []OpOption { return withTop(clientv3.SortByModRevision, clientv3.SortDescend) }

// withTop gets the first key over the get's prefix given a sort order
func withTop(target clientv3.SortTarget, order clientv3.SortOrder) []OpOption {
...
func toLeaseTimeToLiveRequest(id clientv3.LeaseID, opts ...LeaseOption) *pb.LeaseTimeToLiveRequest {
	ret := &LeaseOp{id: id}
	ret.applyOpts(opts)
